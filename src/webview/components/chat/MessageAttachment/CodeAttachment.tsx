...
export const renderSnippet = ({ validLanguage, highlightedText }: { validLanguage: string, highlightedText: string }) => {
    return (
        `<div class="${styles['code-block-wrapper']} code-block-wrapper">
         <div class="${styles['code-block-header']}">
            <span class="${styles['code-language']}">${validLanguage}</span>
            <div class="${styles['header-actions']}">
                <button class="${styles['copy-code-btn']} copy-code-btn" aria-label="Copy code">
                ...
                <button class="${styles['toggle-code-btn']} toggle-code-btn" aria-label="Toggle code visibility">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="${styles['code-block-content']} code-block-content">
